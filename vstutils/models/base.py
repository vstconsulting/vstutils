...
default_extra_metadata = {
    ...
    # list with fields names which will be hidden in list view on frontend
    "hidden_on_frontend_list_fields": None,
    # list with fields names which will be hidden in detail view on frontend
    "hidden_on_frontend_detail_fields": None,
    # name of default view field
    "view_field_name": None,
    # name of field which indicates availability of operations for detail view
    "detail_operations_availability_field_name": None,
...
class ModelBaseClass(ModelBase, metaclass=classproperty.meta):
    ...
    def get_view_class(cls, **extra_options):  # noqa: CFQ001,R0914
        """
        ...
        if value := metadata["detail_operations_availability_field_name"]:
            view_attributes["detail_operations_availability_field_name"] = value
        ...
        serializers = {
            'serializer_class': cls.get_serializer_class(  # pylint: disable=no-value-for-parameter
                ...
                hidden_on_frontend=metadata['hidden_on_frontend_list_fields'],
                metadata=metadata,
            )
        }
        ...
        serializers['serializer_class_one'] = cls.get_serializer_class(  # pylint: disable=no-value-for-parameter
            ...
            view_field_name=metadata['view_field_name'],
            non_bulk_methods=metadata['non_bulk_methods'],
            hidden_on_frontend=metadata['hidden_on_frontend_detail_fields'],
            metadata=metadata,
        )
