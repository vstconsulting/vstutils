...
class BModel(BaseModel):
    """
    Default model class that autogenerate model viewset, separate serializers for list() and retrieve(), filters,
    ...
    Examples:
        ...
        - ``_list_fields`` or ``_detail_fields`` - list of fields which will be listed in entity view.
        ...
        .. note::
            Sometimes you may need to create an
