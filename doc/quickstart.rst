Quick Start
===========
Starting of new project, based on VSTUtils Framework, is rather simple. All you need to do is run several commands.
...
2. **Create new project, based on VSTUtils**
...
Current algorithm of new project Quick Start allows you to create the simplest application, based on VSTUtils framework.
...
.. sourcecode:: python
    ...
    '''
    Some code generated by VSTUtils
    '''
