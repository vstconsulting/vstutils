  ...
  formRoutesBasedOnCustomComponents() {
    ...
    for (let item in this.custom_components_templates) {
      ...
      if (
        ...
        typeof this.custom_components_templates[item]
          .getPathTemplateForRouter === "function"
      ) {
        path_template = this.custom_components_templates[
          item
        ].getPathTemplateForRouter(item);
      }
