...
mixins.base_field_button_mixin = base_field_button_mixin;
...
mixins.file_field_button_mixin = file_field_button_mixin;
...
mixins.base_field_content_mixin = base_field_content_mixin;
...
mixins.base_field_inner_component_mixin = base_field_inner_component_mixin;
...
mixins.field_label_id_mixin = field_label_id_mixin;
...
mixins.base_field_label_mixin = base_field_label_mixin;
...
const base_field_content_readonly_mixin = {
  mixins: [
    base_field_content_mixin,
    base_field_inner_component_mixin,
...
mixins.base_field_content_readonly_mixin = base_field_content_readonly_mixin;
...
mixins.base_field_content_edit_mixin = base_field_content_edit_mixin;
...
const base_field_description_mixin = {
  ...
  computed: {
    description() {
      return this.$t(
        (
          this.field.options.description ||
          this.field.options.help ||
          ""
        ).toLowerCase()
      );
    }
...
mixins.base_field_description_mixin = base_field_description_mixin;
...
mixins.base_field_list_view_mixin = base_field_list_view_mixin;
...
mixins.boolean_field_content_mixin = boolean_field_content_mixin;
...
mixins.choices_field_content_readonly_mixin = choices_field_content_readonly_mixin;
  ...
  methods: {
    ...
    _filterAutocompleteData(search_input, response) {
      ...
      if (
        ...
        !choices.includes(this.field.options.default)
      ) {
...
mixins.autocomplete_field_content_edit_mixin = autocomplete_field_content_edit_mixin;
...
mixins.password_field_content_mixin = password_field_content_mixin;
...
mixins.date_time_field_content_mixin = date_time_field_content_mixin;
...
mixins.color_field_content_mixin = color_field_content_mixin;
...
mixins.crontab_field_content_edit_mixin = crontab_field_content_edit_mixin;
...
mixins.json_field_content_read_only_mixin = json_field_content_read_only_mixin;
...
mixins.field_content_api_object_mixin = field_content_api_object_mixin;
...
mixins.hide_field_in_table_mixin = hide_field_in_table_mixin;
...
mixins.modal_window_and_button_mixin = modal_window_and_button_mixin;
...
mixins.table_row_mixin = table_row_mixin;
...
mixins.fma_table_row_mixin = fma_table_row_mixin;
...
mixins.fma_table_mixin = fma_table_mixin;
...
mixins.fma_search_input_mixin = fma_search_input_mixin;
...
const main_pagination_mixin = {
  ...
  methods: {
    ...
    hideItemOrNot(number) {
      return (
        Math.abs(number - this.current_page) > 2 &&
        number > 3 &&
        this.pages_amount - number > 3
      );
    }
  }
};
mixins.main_pagination_mixin = main_pagination_mixin;
...
mixins.base_modal_window_for_instance_list_mixin = base_modal_window_for_instance_list_mixin;
...
mixins.field_inner_api_object_content_mixin = field_inner_api_object_content_mixin;
...
const field_fk_content_mixin = {
  ...
  watch: {
    ...
    "field.options.additionalProperties.querysets": function(querysets) {
      ...
      this.queryset = this.field.getAppropriateQuerySet(
        this.data,
        this.querysets
      );
    }
      ...
      this.queryset
        ...
        .then(instances => {
          ...
          if (instance && instance.data) {
            this.values_cache[value] = this.field.getPrefetchValue(
              this.data,
              instance.data
            );
...
mixins.field_fk_content_mixin = field_fk_content_mixin;
...
mixins.field_fk_content_readonly_mixin = field_fk_content_readonly_mixin;
        ...
        .then(response => {
          ...
          response.forEach(instances => {
            instances.forEach(instance => {
              let a_data = this.field.getAutocompleteValue(
                this.data,
                instance.data
              );
              results.push({
...
mixins.field_fk_content_editable_mixin = field_fk_content_editable_mixin;
...
mixins.field_binfile_readfile_button_mixin = field_binfile_readfile_button_mixin;
...
mixins.field_binfile_edit_content_mixin = field_binfile_edit_content_mixin;
  ...
  computed: {
    title_for_empty_value() {
      return this.$options.filters.capitalize(
        this.$tc(this.translate_string, 0)
      );
    },
...
mixins.field_namedbinfile_content_mixin = field_namedbinfile_content_mixin;
...
mixins.field_namedbinimage_content_mixin = field_namedbinimage_content_mixin;
  ...
  computed: {
    val() {
      if (this.value && Array.isArray(this.value) && this.value.length > 0) {
        return this.$options.filters.capitalize(
          this.$tc(this.translate_string, this.value.length)
        );
      }
...
mixins.field_multiplenamedbinfile_content_mixin = field_multiplenamedbinfile_content_mixin;
...
const field_multiplenamedbinimage_content_mixin = {
  mixins: [
    ...
    field_namedbinimage_content_mixin
  ]
};
mixins.field_multiplenamedbinimage_content_mixin = field_multiplenamedbinimage_content_mixin;
...
mixins.field_multiplenamedbinfile_edit_content_mixin = field_multiplenamedbinfile_edit_content_mixin;
...
const gui_fields_mixins = {
  ...
  choices: {
    components: {
      field_list_view: {
        mixins: [
          base_field_list_view_mixin,
          choices_field_content_readonly_mixin
        ],
        template: "#template_field_part_list_view",
    ...
    watch: {
      file_obj: function(file) {
        ...
        if (file && file.name) {
          ...
          $(el).text(
            this.$options.filters.capitalize(this.$t("no file selected"))
          );
        }
      }
    },
  ...
  namedbinfile: {
    ...
    components: {
      field_content_readonly: {
        mixins: [
          base_field_content_readonly_mixin,
          field_namedbinfile_content_mixin
        ],
      ...
      copyValueToClipBoard() {
        ...
        try {
          navigator.clipboard
            ...
            .then(() => {
              guiPopUp.success(
                "Value of <b>" +
                  field_name +
                  "</b> field was successfully copied to clipboard."
              );
            })
            .catch(error => {
              throw error;
          ...
          guiPopUp.error(
            "Value of <b>" +
              field_name +
              "</b> field was not copied to clipboard."
          );
        }
      }
    },
    ...
    methods: {
      ...
      setLinksInsideField: function() {
        ...
        for (let i = 0; i < links_array.length; i++) {
          ...
          if (
            match &&
            link.href.search(window.location.href) == -1 &&
            $("*").is(match[0])
          ) {
  ...
  crontab: {
    ...
    components: {
      field_content_edit: {
        mixins: [
          base_field_content_edit_mixin,
          crontab_field_content_edit_mixin
        ]
      }
    },
    computed: {},
  ...
  json: {
    ...
    components: {
      field_content_readonly: {
        mixins: [
          base_field_content_readonly_mixin,
          json_field_content_read_only_mixin
        ]
      }
    }
  },
  ...
  fk: {
    ...
    components: {
      ...
      field_content_readonly: {
        mixins: [
          base_field_content_readonly_mixin,
          field_fk_content_readonly_mixin
        ],
        ...
        methods: {
          ...
          setValue(value) {
            ...
            if (typeof val == "string") {
              val = val.split(
                this.field.options.additionalProperties.view_separator
              );
            }
      ...
      field_content_edit: {
        ...
        methods: {
          ...
          _filterAutocompleteData(search_input, response) {
            ...
            function getDependenceValueAsString(
              parent_data_object,
              field_name
            ) {
              if (
                !field_name ||
                !parent_data_object.hasOwnProperty(field_name)
              ) {
                return undefined;
              }
              let field_dependence_name_array = [];
            ...
            let all = this.querysets.map(qs => {
              ...
              tabSignal.emit(
                "filter.{fieldType}.{modelName}.{fieldName}".format(
                  format_data
                ),
                signal_obj
              );
            ...
            Promise.all(all)
              .then(results => {
                ...
                results.forEach(instances => {
                  instances.forEach(instance => {
                    matches.push(
                      this.field.getAutocompleteValue(this.data, instance.data)
                    );
                  });
                });
          ...
          if (data[key] !== this.parent_values[key]) {
            ...
            if (this.realField.options && this.value !== undefined) {
              if (this.realField.options.save_value === false) {
                ...
                this.realField.options.format !==
                  this.previous_realField.options.format
              ) {
                this.cleanValue();
              }
            }
...
mixins.gui_fields_mixins = gui_fields_mixins;
